...
<template>
  <ModalDialog @close="closeExport">
    ...
    <p class="hint">Картинка удобна, чтобы отправить план в мессенджер. Чертёж SVG сохраняется в масштабе 1:50: если распечатать его в масштабе 100%, 1 см на листе равен 50 см комнаты.</p>
    <div class="btnrow">
      <button class="btn" @click="downloadPNG">Скачать картинку PNG</button>
